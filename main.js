document.addEventListener("DOMContentLoaded", function () {
    ...
    // Obtener el SteamID64 del usuario después de que haya ingresado al servidor de Garry's Mod
    const steamID64 = 'STEAMID64_DEL_USUARIO';

    // Realizar la solicitud a la API de Steam
    fetch(`${steamAPIURL}?steamid=${steamID64}`, { method: 'GET', mode: 'cors' })
        ...
        .catch(error => {
            ...
            // Manejar el error aquí, por ejemplo, mostrar una imagen predeterminada o un mensaje de error
